...
- **Normal** — the full diff of the focused revision (all files), with change/commit IDs, author/committer signatures, and any bookmarks pointing to the revision separated from the full description by a divider.
